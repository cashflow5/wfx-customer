...
<#-- @ftlvariable name="address" type="com.yougou.wfx.customer.model.usercenter.myaddress.AccountAddressVo" -->
<#-- @ftlvariable name="errorMsg" type="java.lang.String" -->
<!DOCTYPE html>
<html>
<head>
<#include "../../layouts/meta.ftl">
    <title>优购微零售_修改收货地址</title>
...
<div class="viewport yg-add-address">
    ...
    <div class="mui-content">
        <section>
            <form class="mui-input-group" id="addressForm" action="${context}/usercenter/myaddress/edit.sc" method="post">
                <input hidden name="id" id="id" value="${(address.id)!''}" />
                ...
                <div class="yg-floor ptb10 border-bottom">
                    <div class="mui-row">
                        ...
                        <div class="mui-col-sm-2 mui-col-xs-2">
                            <div class="mui-switch mui-switch-mini fr mt5 <#if (address.defaultAddress)!false>mui-active</#if>"
...
<script src="${context}/static/js/yg-my-address-edit.js?v=${static_version}" type="text/javascript" charset="utf-8"></script>
