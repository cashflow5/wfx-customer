...
<div id="pageShippedTightRefund" class="viewport">
    ...
    <div class="mui-content">
        <form id="refundForm" action="${context}/order/refund/${(orderRefund.refundNo)!''}/editRefund.sc"
              method="post">
        <#if ((orderRefund.refundType)!'')=='ONLY_REFUND' || !((orderRefund.delivered)!false)>
            ...
            <section class="yg-box yg-two-layout-btn yg-btn-straight">
                <div class="mui-row mt10 return-type-wrap">
                    <div class="mui-col-sm-6 mui-col-xs-6">
                        <a href="javascript:;" class="mui-btn return-type-btn return-goods" data-refundno="${(orderRefund.refundNo)!''}">退货退款</a>
                    </div>
                    <div class="mui-col-sm-6 mui-col-xs-6">
                        <a href="javascript:;"
                           class="mui-btn selected return-type-btn only-refund"
