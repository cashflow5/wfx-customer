...
<div id="pageShippedTightRefund" class="viewport">
    ...
    <div class="mui-content">
        <form id="editReturnGoodsForm"
              action="${context}/order/refund/${(orderRefund.refundNo)!''}/editReturnGoods.sc"
              method="post">
            ...
            <section class="yg-box yg-two-layout-btn yg-btn-straight">
                <div class="mui-row mt10 return-type-wrap">
                    <div class="mui-col-sm-6 mui-col-xs-6">
                        <a href="javascript:;"
                           class="mui-btn selected return-type-btn return-goods"
                           data-refundno="${(orderRefund.refundNo)!''}">退货退款</a>
                    </div>
                    <div class="mui-col-sm-6 mui-col-xs-6">
                        <a href="javascript:;"
                           class="mui-btn return-type-btn only-refund"
                           data-refundno="${(orderRefund.refundNo)!''}">仅退款</a>
                    </div>
                </div>
            </section>
                ...
                <section class="plr20">
                    ...
                    <div class="mui-numbox" data-numbox-min="0" data-numbox-max="${(orderRefund.canReturnNum)!'0'}">
                        ...
                        <input id="proNum"
                               ...
                               type="number"
                               value="${(orderRefund.proNum)!((orderRefund.canReturnNum)!'0')}" />
            ...
            <section class="plr20">
                ...
                <input id="refundFee"
                       name="refundFee"
                       type="text"
                       placeholder="${((orderRefund.refundFee)!((orderRefund.canReturnFee)!'0'))?string('0.00')}"
                       value="${((orderRefund.refundFee)!((orderRefund.canReturnFee)!'0'))?string('0.00')}"
                       readonly />
                <p>退款说明 <span class="ml10 Gray">（可不填）</span></p>
                <textarea id="description" name="description" rows="5" placeholder="0-200字">${(orderRefund.description)!''}</textarea>
            </section>
            <section class="yg-btn-straight">
                <a href="javascript:;" class="mui-btn mui-btn-danger mui-btn-block" id="submitEditReturnGoodsForm">提交申请</a>
            </section>
        </form>
    </div>
</div>
